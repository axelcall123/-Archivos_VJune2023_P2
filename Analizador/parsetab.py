...
_lr_productions = [
  ...
  ('inicio -> lexico','inicio',1,'p_inicio','gramar.py',126),
  ('lexico -> lexico comandos','lexico',2,'p_lexico','gramar.py',133),
  ('lexico -> comandos','lexico',1,'p_lexico','gramar.py',134),
  ('comandos -> maincomando subcomando','comandos',2,'p_comandos','gramar.py',144),
  ('comandos -> maincomando','comandos',1,'p_comandos','gramar.py',145),
  ('maincomando -> CREATE','maincomando',1,'p_main_comando','gramar.py',159),
  ('maincomando -> DELETE','maincomando',1,'p_main_comando','gramar.py',160),
  ('maincomando -> COPY','maincomando',1,'p_main_comando','gramar.py',161),
  ('maincomando -> TRANSFER','maincomando',1,'p_main_comando','gramar.py',162),
  ('maincomando -> RENAME','maincomando',1,'p_main_comando','gramar.py',163),
  ('maincomando -> MODIFY','maincomando',1,'p_main_comando','gramar.py',164),
  ('maincomando -> BACKUP','maincomando',1,'p_main_comando','gramar.py',165),
  ('maincomando -> RECOVERY','maincomando',1,'p_main_comando','gramar.py',166),
  ('maincomando -> DELETE_ALL','maincomando',1,'p_main_comando','gramar.py',167),
  ('maincomando -> OPEN','maincomando',1,'p_main_comando','gramar.py',168),
  ('subcomando -> subcomando sub','subcomando',2,'p_subcomando','gramar.py',174),
  ('subcomando -> sub','subcomando',1,'p_subcomando','gramar.py',175),
  ('sub -> TYPE tipo','sub',2,'p_sub','gramar.py',188),
  ('sub -> NAME nombre','sub',2,'p_sub','gramar.py',189),
  ('sub -> BODY STRING','sub',2,'p_sub','gramar.py',190),
  ('sub -> PATH RUTA','sub',2,'p_sub','gramar.py',191),
  ('sub -> FROM RUTA','sub',2,'p_sub','gramar.py',192),
  ('sub -> TO RUTA','sub',2,'p_sub','gramar.py',193),
  ('sub -> TYPE_TO tipo','sub',2,'p_sub','gramar.py',194),
  ('sub -> TYPE_FROM tipo','sub',2,'p_sub','gramar.py',195),
  ('sub -> IP AIP','sub',2,'p_sub','gramar.py',196),
  ('sub -> PORT APORT','sub',2,'p_sub','gramar.py',197),
  ('tipo -> BUCKET','tipo',1,'p_tipo','gramar.py',211),
  ('tipo -> SERVER','tipo',1,'p_tipo','gramar.py',212),
  ('nombre -> ARCHIVO','nombre',1,'p_nombre','gramar.py',217),
  ('nombre -> STRING','nombre',1,'p_nombre','gramar.py',218),
  ('nombre -> RUTA','nombre',1,'p_nombre','gramar.py',220),
]
